...
// ── МЕТКИ СТАТОВ ПРЕДМЕТОВ ИЗ БД (game keys → русские названия из locale) ────
const DB_STAT_LABELS = [
  { key:'attack',                                      label:'Атака' },
  { key:'defense',                                     label:'Защита' },
  { key:'max_health',                                  label:'Запас здоровья' },
  { key:'mana',                                        label:'Запас маны' },
  { key:'max_mana',                                    label:'Запас маны' },
  { key:'hp',                                          label:'Запас здоровья' },
  { key:'hp_inc',                                      label:'Запас здоровья' },
  { key:'change_heal_sent_percent',                    label:'Эффективность лечения',                           pct:true },
  { key:'change_health_regeneration_speed',            label:'Восстановление жизни вне боя' },
  { key:'critical_attack_multiplier',                  label:'Сила крит. урона',                                pct:true },
  { key:'chance_critical_attack',                      label:'Шанс крит. удара',                                pct:true },
  { key:'crit_chance',                                 label:'Шанс крит. урона',                                pct:true },
  { key:'change_absorb_critical',                      label:'Защита от крит. удара',                           pct:true },
  { key:'resist_to_fire_percent',                      label:'Сопр. магии огня',                                pct:true },
  { key:'resist_to_wind_percent',                      label:'Сопр. магии ветра',                               pct:true },
  { key:'resist_to_light_percent',                     label:'Сопр. магии света',                               pct:true },
  { key:'weakness_to_fire_percent',                    label:'Защита стихий',                                   pct:true },
  { key:'weakness_to_light_percent',                   label:'Защита стихий',                                   pct:true },
  { key:'weakness_to_wind_percent',                    label:'Защита стихий',                                   pct:true },
  { key:'change_damage_sent_percent',                  label:'Эффективность атаки',                             pct:true },
  { key:'change_damage_received_percent',              label:'Эффективность защиты',                            pct:true },
  { key:'change_damage_feedback_percent',              label:'Вампиризм',                                       pct:true },
  { key:'run_speed',                                   label:'Скорость в бою',                                  pct:true },
  { key:'walk_speed',                                  label:'Скорость вне боя',                                pct:true },
  { key:'change_experience_received_percent',          label:'Получение опыта',                                 pct:true },
  { key:'change_experience_for_mobs_received_percent', label:'Получение опыта с монстров',                      pct:true },
  { key:'charm',                                       label:'Харизма' },
  { key:'karma',                                       label:'Карма' },
  { key:'gifts_karma',                                 label:'Праздничное настроение' },
  { key:'killer_chance',                               label:'Шанс нанести смертельный удар',                   pct:true },
  { key:'ray_gun',                                     label:'Энергетическое оружие' },
  { key:'change_reputation_rep14_received_percent',    label:'Получение славы на аренах и в Земле Мертвых',     pct:true },
  { key:'change_reputation_pvp2_received_percent',     label:'Репутация Гладиатора',                            pct:true },
  { key:'change_reputation_pvp1_received_percent',     label:'Репутация Завоевателя',                           pct:true },
  { key:'change_reputation_pvp6_received_percent',     label:'Репутация Властителя земель',                     pct:true },
  { key:'change_reputation_pve1_received_percent',     label:'Репутация Археолога',                             pct:true },
  { key:'change_reputation_pve2_received_percent',     label:'Репутация Ведьмака',                              pct:true },
  { key:'change_reputation_pve4_received_percent',     label:'Репутация Охотника на демонов',                   pct:true },
  { key:'change_reputation_pve5_received_percent',     label:'Репутация Дрессировщика',                         pct:true },
  { key:'change_reputation_rep15_received_percent',    label:'Репутация Первооткрывателя',                      pct:true },
  { key:'change_reputation_rep19_received_percent',    label:'Репутация Чародея',                               pct:true },
  { key:'change_reputation_rep21_received_percent',    label:'Репутация Королевской Гвардии',                   pct:true },
  { key:'change_reputation_rep25_received_percent',    label:'Репутация Крылатого воителя',                     pct:true },
  { key:'change_reputation_rep26_received_percent',    label:'Репутация Племен Джунго',                         pct:true },
  { key:'change_reputation_rep27_received_percent',    label:'Репутация Пиратов Флайна',                        pct:true },
  { key:'change_reputation_rep28_received_percent',    label:'Репутация Храмов Муун',                           pct:true },
  { key:'change_reputation_pve6_received_percent',     label:'Репутация Защитник праздника',                    pct:true },
  { key:'change_reputation_rep30_received_percent',    label:'Репутация Месяца Цветов',                         pct:true },
  { key:'change_reputation_rep31_received_percent',    label:'Репутация Глубинного воителя',                    pct:true },
  { key:'change_reputation_rep33_received_percent',    label:'Репутация Гоблинского Рая',                       pct:true },
];
...
const ARTIFACTS = [
  ...
  { slotId:'stone_witch',   group:'Камень Ведьмака',           name:'Скрижаль Ведьмака',                  quality:'orange', img:'icons/artefact_cards_witcher.jpg',                     stats:{ hp:500, def:4, mana:200, def_eff:8, heal_eff:8 } },
  ...
  { slotId:'stone_luck',    group:'Камень Удачи',              name:'Скрижаль Удачи',                     quality:'orange', img:'icons/artefact_cards_fair.jpg',                        stats:{ atk:6, hp:400, def:3, mana:200, def_eff:4, atk_eff:5, heal_eff:5, speed:3 } },
  ...
  { slotId:'stone_lost',    group:'Камень Потерянных Земель',  name:'Скрижаль Потерянных Земель',         quality:'orange', img:'icons/artefact_cards_inst.jpg',                        stats:{ atk:10, mana:200, def_eff:6, atk_eff:8, crit_chance:4 } },
  ...
  { slotId:'stone_labor',   group:'Камень Труда',              name:'Скрижаль Труда',                     quality:'orange', img:'icons/artefact_cards_proff.jpg',                       stats:{ atk:10, hp:600, def:4, mana:200, atk_eff:8, crit_chance:4, heal_eff:6 } },
