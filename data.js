...
const ARTIFACTS = [
  ...
  { slotId:'stone_witch',   group:'Камень Ведьмака',           name:'Скрижаль Ведьмака',                  quality:'orange', img:'stats_calculator/artefacts/green_demonic_card.png',   stats:{ hp:500, def:4, mana:200, def_eff:8, heal_eff:8 } },
  ...
  { slotId:'stone_luck',    group:'Камень Удачи',              name:'Скрижаль Удачи',                     quality:'orange', img:'stats_calculator/artefacts/yellow_demonic_card.png',  stats:{ atk:6, hp:400, def:3, mana:200, def_eff:4, atk_eff:5, heal_eff:5, speed:3 } },
  ...
  { slotId:'stone_lost',    group:'Камень Потерянных Земель',  name:'Скрижаль Потерянных Земель',         quality:'orange', img:'stats_calculator/artefacts/blue_demonic_card.png',    stats:{ atk:10, mana:200, def_eff:6, atk_eff:8, crit_chance:4 } },
  ...
  { slotId:'stone_labor',   group:'Камень Труда',              name:'Скрижаль Труда',                     quality:'orange', img:'stats_calculator/artefacts/red_demonic_card.png',     stats:{ atk:10, hp:600, def:4, mana:200, atk_eff:8, crit_chance:4, heal_eff:6 } },
